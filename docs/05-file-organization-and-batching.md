...
|---|---|---|---|
| **1** | **Ideas** | Ten hooks per topic, using the hook generator in `prompts/00-master-prompt-library.txt`. Write only the hook | Keep three, file the rest in `ideas/00-idea-bank.md`. Most die here, cheaply |
